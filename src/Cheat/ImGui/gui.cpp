...
void gui::Render() noexcept
{
	...
	ImGui::Checkbox("Toggle Godmode", &PedFactory->Ped->Godmode);
	ImGui::Checkbox("Toggle Never Wanted", &Config::isNeverWanted);
	ImGui::SliderFloat("Movement Speed", &PedFactory->Ped->PlayerInfo->MovSpeedX, 1, 5);
	if (ImGui::Button("Set Wanted Level to 0")) PedFactory->Ped->PlayerInfo->WantedLevel = 0;
	ImGui::Text("");
	...
	if (*(bool*)isInVehicle) // if player is in vehicle: display vehicle cheats
	{
		...
		ImGui::Checkbox("0 Gravity", &Config::isZeroGrav);
	}
